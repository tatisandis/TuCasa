...
<head>
 ...
 <!-- Compiled and minified CSS -->
  ...
  <!-- Compiled and minified JavaScript -->
	...
	<script src="../../assets/plugins/dropify.min.js"></script>
				...
				<legend><i class="fa fa-home" aria-hidden="true"></i>  Datos Publicación</legend>
				 <div class="row">
				 	<div class="input-field col s6">
						<select name="tipoPublicacion" id="tipoPublicacion" data-validation="required">
				...
				<div class="input-field col s12">
					<div class="row">
						...
						<label for="usado">Usado</label>
  						<input class="with-gap col s3" name="estadoInmueble" type="radio" id="enConstruccion" value="en_construccion" data-validation="required"/>
			...
			<div class="row">
				<div class="col s12 center">
					<button type="submit" class="btn waves-effect waves-light" name="botonRegistrar">
					 Publicar 
					 <i class="material-icons left">add_to_queue</i>
					 </button>
				</div>
			</div>
		</form>				
